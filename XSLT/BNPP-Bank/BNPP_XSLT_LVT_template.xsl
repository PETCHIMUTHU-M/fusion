...
<xsl:if test="not(OutboundPayment/PayeeBankAccount/SwiftCode='')">
 <BIC>
  ...
  <ClrSysId>
  <Prtry>
   <xsl:text>VNNCC</xsl:text> 
  </Prtry>
  </ClrSysId>
  </ClrSysMmbId>
  <Nm>
    <xsl:value-of select="substring(OutboundPayment/PayeeBankAccount/BankName,1,140)" />
  </Nm>
  <PstlAdr>
  <Ctry>
 ...
 <Nm>
  ...
  <AdrLine>
  <xsl:value-of select="substring(OutboundPayment/SupplierorParty/Address/AddressLine1,1,70)" /> 
  <xsl:value-of select="substring(OutboundPayment/SupplierorParty/Address/AddressLine2,1,70)" />
  <xsl:value-of select="substring(OutboundPayment/SupplierorParty/Address/AddressLine3,1,70)" />
  </AdrLine>
  </PstlAdr>
  </Cdtr>
 <CdtrAcct>
